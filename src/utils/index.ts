...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from 'techbandswap'
...
const abiBSC = [
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'amountBNB', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
...
export function getRouterContract(_: number, library: Web3Provider, account?: string): Contract {
  return getContract(ROUTER_ADDRESS, abiBSC, library, account)
}
